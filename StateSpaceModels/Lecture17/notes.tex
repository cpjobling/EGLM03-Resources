...
%% Lecture 17: Transformation of States and System Diagonalization
...
\ifslidesonly
\begin{slide}
   \heading{Pre-Class Presentation: Transformation of State Models}
\begin{itemize}
...
% Session marker slides
\ifslidesonly
\begin{slide}
\heading{Summary of Pre-Class Presentation}
\begin{itemize}
\item Eigenvalues and eigenvectors
\item System transformation
\item Diagonalization of a state space model
...
\end{slide}
\begin{slide}
\heading{Example 1: Eigenvalues and Eigevectors}
...
\end{slide}
\begin{slide}
\heading{Example 2: System Transformation}
Given the system represented in state space by the following equations
\input{example2}
\end{slide}
\begin{slide}
\heading{Example 3: Diagonalization of a system in state space}
Given the system shown below, find the diagonal (normal form) system that is similar.
\input{example3}
\end{slide}
\begin{slide}
\heading{Example 4: Solution of General State Equations}
...
\ifslidesonly
\begin{slide}
\heading{System Transformations in Matlab}
\end{slide}
\fi
\begin{slide}
